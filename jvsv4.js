...
document.getElementById("savePopup").addEventListener("click", () => {
  ...
  if (pendingreadBy !== null) {
    readBy = pendingreadBy;
    pendingreadBy = null;
  ...
  alertMessage = pendingalertMessage;
  pendingalertMessage = null;
}
  if (pendingbuttonsControl !== null) {
  buttonsControl = pendingbuttonsControl;
  pendingbuttonsControl = null;
}
  if (pendingallRootWords !== null) {
  allRootWords = pendingallRootWords;
  pendingallRootWords = null;
}
  if (pendingrandomOptionCount !== null) {
  randomOptionCount = pendingrandomOptionCount;
  pendingrandomOptionCount = null;
}
  if (pendingrevealAns !== null) {
  revealAns = pendingrevealAns;
  pendingrevealAns = null;
}
  ...
  if (pendingminOptions !== null) {
  minOptions = pendingminOptions;
  pendingminOptions = null;
}
  if (pendingmaxOptions !== null) {
  maxOptions = pendingmaxOptions;
  pendingmaxOptions = null;
}
  if (pendingcorrectPercent !== null) {
  correctPercent = pendingcorrectPercent;
  pendingcorrectPercent = null;
}
viewFunction();
});
...
function initStepSelector() {
  ...
  const minOptions = document.getElementById("minOptionSelector");
const maxOptions = document.getElementById("maxOptionSelector");
  const correctPercent = document.getElementById("correctPercentageSelector");
  const bigTexts = document.getElementById("textSizeSelector");
  const readBy = document.getElementById("readingOrderSelect");

  
  function updateStepOptions(readBy) {
    const options = STEP_OPTIONS[readBy];
  ...
  updateStepOptions(readBy.toString());
...
readBy.addEventListener("change", (e) => {
    pendingreadBy = parseInt(e.target.value);
  updateStepOptions(pendingreadBy.toString());
  });
  minOptions.addEventListener("change", (e) => {
    pendingminOptions = parseInt(e.target.value);
  });
  maxOptions.addEventListener("change", (e) => {
    pendingmaxOptions = parseInt(e.target.value);
  });

  correctPercent.addEventListener("change", (e) => {
    pendingcorrectPercent = parseInt(e.target.value);
  });
bigTexts.addEventListener("change", (e) => {
    pendingbigTexts = parseInt(e.target.value);
  });
...
document.getElementById("searchByMeaning").checked = (searchByMeaning === 1);
  ...
  document.getElementById("questionMode").checked = (questionMode === 1);
...
document.getElementById("alertMessage").addEventListener("change", (e) => {
  pendingAlertMessage = e.target.checked ? 1 : 0;
});
  document.getElementById("questionMode").addEventListener("change", (e) => {
  pendingquestionMode = e.target.checked ? 1 : 0;
});
  document.getElementById("revealAns").addEventListener("change", (e) => {
  pendingrevealAns = e.target.checked ? 1 : 0;
});
  document.getElementById("randomOptionCount").addEventListener("change", (e) => {
  pendingrandomOptionCount= e.target.checked ? 1 : 0;
});
  document.getElementById("buttonsControl").addEventListener("change", (e) => {
  pendingbuttonsControl = e.target.checked ? 1 : 0;
});
document.getElementById("searchByMeaning").addEventListener("change", (e) => {
  pendingSearchByMeaning = e.target.checked ? 1 : 0;
});
  document.getElementById("allRootWords").addEventListener("change", (e) => {
  pendingallRootWords = e.target.checked ? 1 : 0;
});
